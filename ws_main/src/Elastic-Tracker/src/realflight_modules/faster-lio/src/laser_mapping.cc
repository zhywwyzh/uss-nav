...
bool LaserMapping::LoadParams(ros::NodeHandle &nh) {
    ...
    nh.param<std::vector<double>>("/mapping/rotation2virtualbody_pcl", rotation2virtualbody_pcl, std::vector<double>());
    nh.param<std::vector<double>>("/mapping/rotation2virtualbody_imu", rotation2virtualbody_imu, std::vector<double>());
...
bool LaserMapping::LoadParamsFromYAML(const std::string &yaml_file) {
    ...
    try {
        ...
        ROS_ERROR("y-----------------------rotation2virtualbody_pcl-----------------------");
        ROS_ERROR("y-----------------------rotation2virtualbody_pcl-----------------------");
        ROS_ERROR("y-----------------------rotation2virtualbody_pcl-----------------------");
        ROS_ERROR("y-----------------------rotation2virtualbody_pcl-----------------------");
        ...
        ROS_ERROR("y-----------------------rotation2virtualbody_pcly-----------------------");
        ROS_ERROR("y-----------------------rotation2virtualbody_pcly-----------------------");
        ROS_ERROR("y-----------------------rotation2virtualbody_pcly-----------------------");
        ROS_ERROR("y-----------------------rotation2virtualbody_pcly-----------------------");
        ROS_ERROR("y-----------------------rotation2virtualbody_pcly-----------------------");
