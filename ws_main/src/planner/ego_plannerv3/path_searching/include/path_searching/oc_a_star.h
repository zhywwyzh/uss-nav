// #ifndef _OC_A_STAR_H_
// #define _OC_A_STAR_H_
...
// namespace oc_a_star // obstacle clearance A star
// {
...
// 		unsigned int rounds{0}; // Distinguish every call
...
// 		double gScore{inf}, fScore{inf}, OccDist{-inf};
...
// 		inline int checkOccupancy(const Eigen::Vector3d &pos) { return (grid_map_->getInflateOccupancy(pos) > 0); }

// 		inline double getDistance(const Eigen::Vector3d &pos) { return (grid_map_->getDistancePessi(pos)); }
...
// 		void initAstar(GridMap::Ptr occ_map, const Eigen::Vector3i pool_size);

// 		ASTAR_RET AstarSearch(const double radius,
