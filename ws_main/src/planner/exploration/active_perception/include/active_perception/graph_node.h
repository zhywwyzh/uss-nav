...
public:
  ...
  static bool searchPath(const Vector3d& p1, const Vector3d& p2, vector<Vector3d>& path, double& dis_res);
  ...
  static double vm_, am_, yd_, ydd_, w_dir_, sensor_range_;

  static dyn_a_star::AStar::Ptr  a_star_;
  static MapInterface::Ptr       map_;
};
}
#endif