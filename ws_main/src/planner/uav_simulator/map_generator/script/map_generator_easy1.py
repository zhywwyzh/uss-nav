...
class map_generator(object):
    ...
    def init_params(self):
        ...
        self.dimx = rospy.get_param("map/x_size", default=40.0)
        self.dimy = rospy.get_param("map/y_size", default=5.0)
    ...
    def make_map(self):
        ...
        # floor
        self.add_layer([self.dimx, 3.0*self.dimy], [0, 0, 0.1])
        # ceiling
        ...
        # self.add_box([6.0, 0.10, self.dimz], [
        #              12.0, self.dimy / 2, self.dimz / 2.0])
        self.add_box([4.0, 0.10, self.dimz], [
                     18.0, self.dimy / 2, self.dimz / 2.0])

        self.add_box([20.0, 0.10, self.dimz],
                     [-10.0, self.dimy / 2, self.dimz / 2.0])

        # # button
        self.add_box([self.dimx, 0.10, self.dimz], [
                     0, -self.dimy / 2, self.dimz / 2.0])
