...
class map_generator(object):
    ...
    def init_params(self):
        ...
        self.dimx = rospy.get_param("map/x_size", default=14.0)
    ...
    def make_map(self):
        ...
        # Only Ground DBG
        # # mid
        # self.add_box([0.10, self.dimy, 0.6],
        #              [-self.dimx / 2 + 4, 0, 0.6])

        # # box
        # self.add_box([4.0, 2.0, 0.6],
        #              [-1.0, 1.5, 0.6])

        # self.add_box([4.0, 0.1, self.dimz],
        #              [-1.0, 0.5, self.dimz / 2.0])
